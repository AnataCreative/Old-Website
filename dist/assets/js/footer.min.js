...
anatacreative.app=function(a){this.app,function(){anatacreative.menu(),anatacreative.forms(),anatacreative.nav()}()};var ready=function(a){if("function"==typeof a)return"complete"===document.readyState?a():void document.addEventListener("DOMContentLoaded",a,!1)};ready(function(){anatacreative.app()});