...
anatacreative.forms=function(e){var t,s,a=(this.forms,function(e){e.preventDefault(),t.classList.add("form--submitting"),t.classList.remove("form--error"),s.classList.add("submit-btn--loading"),s.setAttribute("disabled",!0);var a="name="+this.name.value+"&email="+this.email.value+"&message="+this.message.value+"&_gotcha="+this._gotcha.value,i=new XMLHttpRequest;i.open("POST","//formspree.io/info@anatacreative.com",!0),i.setRequestHeader("Content-Type","application/x-www-form-urlencoded; charset=UTF-8"),i.setRequestHeader("Accept","application/json"),i.addEventListener("load",function(e){t.classList.remove("form--submitting"),t.classList.add("form--success")}),i.addEventListener("error",function(e){t.classList.remove("form--submitting"),t.classList.add("form--error"),s.classList.remove("submit-btn--loading"),s.removeAttribute("disabled")}),i.send(a)}),i=function(){s=document.getElementById("form-submit"),t.addEventListener("submit",a)};(function(){t=document.getElementById("form"),t&&i()})()};
anatacreative.menu=function(e){var n,i,t=this.menu;t.close=function(){i.classList.remove("main-nav__mobile-container--active"),n.classList.remove("main-nav__mobile-toggle--active")};(function(){n=document.getElementById("main-nav-mobile-toggle"),i=document.getElementById("main-nav-mobile-container"),n.addEventListener("click",function(){i.classList.toggle("main-nav__mobile-container--active"),n.classList.toggle("main-nav__mobile-toggle--active")})})()};
anatacreative.nav=function(n){var t,e,a=(this.nav,!1),i="ease",o=100,c=500,s=function(n){window.location.href!==n&&(history.pushState(null,null,n),r(n))},r=function(n){if(!a){a=!0;var e,c,s=!1,r=!1;c={opacity:[0,1]},anatacreative.menu.close(),u(n),document.body.classList.add("content-loading"),Velocity(t,c,{easing:i,duration:o,delay:0,complete:function(){s=!0,r&&l(e)}});var d=new XMLHttpRequest;d.open("GET",n,!0),d.onload=function(){if(d.status>=200&&d.status<400){var t=document.createElement("div");t.innerHTML=this.responseXML.body.innerHTML,e=t.getElementsByClassName("js-main-content")[0].innerHTML,r=!0,document.title=this.responseXML.title,s&&l(e)}else window.location.href=n},d.onerror=function(){window.location.href=n},d.responseType="document",d.send()}},l=function(n){t.innerHTML=n,f(),d(),a=!1},d=function(){document.body.classList.remove("content-loading"),Velocity(t,{opacity:[1,0],translateZ:0,translateY:[0,2]},{easing:i,duration:c,delay:0})},u=function(n){var t=!1;[].forEach.call(e,function(e,a){e.classList.remove("main-nav__item--active"),e.blur(),e.href===n&&(t=!0,e.classList.add("main-nav__item--active"))}),t||(n.indexOf("projects")>-1||n.indexOf("projecten")>-1)&&e[1].classList.add("main-nav__item--active")},f=function(){m(),anatacreative.forms(),document.body.scrollTop=0},m=function(){[].forEach.call(document.querySelectorAll(".js-nav-link"),function(n,t){n.addEventListener("click",function(n){n.preventDefault(),s(this.href,"vert","main",this.dataset.scrollTarget)})})};(function(){window.history&&history.pushState&&(t=document.getElementById("main-content"),e=document.querySelectorAll(".js-main-nav-link"),m(),window.addEventListener("popstate",function(){r(location.href,"vert","main")}))})()};
anatacreative.app=function(a){this.app,function(){anatacreative.menu(),anatacreative.forms(),anatacreative.nav()}()};var ready=function(a){return"function"==typeof a?"complete"===document.readyState?a():void document.addEventListener("DOMContentLoaded",a,!1):void 0};ready(function(){anatacreative.app()});