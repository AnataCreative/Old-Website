...
anatacreative.menu=function(n){var e,t;this.menu,function(){e=document.getElementById("main-nav-mobile-toggle"),t=document.getElementById("main-nav-mobile-container"),e.addEventListener("click",function(){t.classList.toggle("main-nav__mobile-container--active")})}()};
anatacreative.app=function(a){this.app,function(){anatacreative.menu(),anatacreative.forms()}()};var ready=function(a){return"function"==typeof a?"complete"===document.readyState?a():void document.addEventListener("DOMContentLoaded",a,!1):void 0};ready(function(){anatacreative.app()});